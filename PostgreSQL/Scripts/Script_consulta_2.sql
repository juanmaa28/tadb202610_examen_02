-- ============================================
-- ETAPA 3: Diagnóstico de dominancia geográfica relativa
-- Scripts Examen #2
...
continent_participation AS (
    ...
    SELECT
        ...
        gwp.global_points,
        ROUND(
            (cwp.continent_points::numeric / gwp.global_points) * 100, 2
    ...
    JOIN global_weekly_points gwp ON gwp.chart_date = cwp.chart_date
)
